...
#define DIG_IO_LIST \
    ...
    DIG_IO_ENTRY(threep_in,   GPIOB, GPIO4,  PinMode::INPUT_FLT)   \
    ...
    DIG_IO_ENTRY(d3_out,      GPIOA, GPIO4,  PinMode::OUTPUT)      \
    DIG_IO_ENTRY(evseact_out, GPIOB, GPIO15, PinMode::OUTPUT)      \
    DIG_IO_ENTRY(ch1ena_out,  GPIOB, GPIO14, PinMode::OUTPUT)      \
    DIG_IO_ENTRY(ch2ena_out,  GPIOB, GPIO13, PinMode::OUTPUT)      \
    DIG_IO_ENTRY(ch3ena_out,  GPIOB, GPIO12, PinMode::OUTPUT)      \
    DIG_IO_ENTRY(ch1act_out,  GPIOB, GPIO5,  PinMode::OUTPUT)      \
    DIG_IO_ENTRY(ch2act_out,  GPIOB, GPIO6,  PinMode::OUTPUT)      \
    DIG_IO_ENTRY(ch3act_out,  GPIOB, GPIO7,  PinMode::OUTPUT)      \
